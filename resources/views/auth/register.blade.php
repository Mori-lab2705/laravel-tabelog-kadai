         ...
         <div class="col-md-5">
             ...
             <form method="POST" action="{{ route('register') }}">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-md-7">
                         <input type="text" class="form-control @error('postal_code') is-invalid @enderror nagoyameshi-login-input" name="postal_code" value="{{ old('postal_code') }}" required placeholder="150-0043">
                     </div>
                 </div>
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-md-7">
                         <input type="text" class="form-control @error('address') is-invalid @enderror nagoyameshi-login-input" name="address" value="{{ old('address') }}" required placeholder="東京都渋谷区道玄坂２丁目１１−１">
                     </div>
                 </div>
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-md-7">
                         <input type="text" class="form-control @error('phone') is-invalid @enderror nagoyameshi-login-input" name="phone" value="{{ old('phone') }}" required placeholder="03-5790-9039">
                     </div>
                 </div>
